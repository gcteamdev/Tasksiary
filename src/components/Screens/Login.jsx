              ...
              <div>
                <div className="d-flex justify-content-between mb-5">
                  <div className="d-flex logobar">
                    ...
                    <h6 className="mt-3 font-weight-bolder logoName">
                      workarise
                    </h6>
                  </div>

                  <img
                    className="p-4 settingIcon"
                    src={Settings}
                    alt="settings"
                  />
                </div>
              </div>
              <div className=" p-md-5 mx-md-4 form-ctn">
                ...
                <form className="col-6 text-center m-auto ">
                  <div className="d-flex justify-content-between">
                    ...
                    <div className="mt-4 ">
                      <h3 className="text-center headerLogin mt-3">
                        Welcome back, José
                      </h3>
                      <h6 className="LoginOrNew">
                        Please sign in or{' '}
                        <span className="createNew">create a new account</span>
                      </h6>
                    </div>
                  </div>
                  ...
                  <div className="form-group">
                    <div
                      ...
                      className="btn btn-dark col-12 btn-block"
                    >
                      Log in
                    </div>
                  </div>
                  <div className="d-flex mt-1 text-muted">
                    ...
                    <h6 className="rememberMe mt-3 m-2">
                      {' '}
                      Sign in with Gmail or Microsoft{' '}
                    </h6>
                    <hr className="hr-break" />
                  </div>
                  <div className="d-flex justify-content-between mb-5">
                    <img
                      className="Gmail-Msoft"
                      src={SignGmail}
                      alt="signIn with Gmail"
                    />
                    <img
                      className="Gmail-Msoft"
                      src={SignMsoft}
            ...
            <div className="col-lg-6 d-flex align-items-center gradient-custom-2 bg-primary">
              <div className="text-dark px-3 py-4 p-md-5 mx-md-4 d-column greenCtn ">
                <div className="col-12  text-center">
                  <img
                    src={TasksSnap}
                    alt="group-tasks-snapshot"
                    className="tasksSnap"
                  />
                </div>
                <h4 className="mb-4 text-center">Daily Tasks</h4>
                <p className="small text-center">
                  Check your daily tasks to see what you and your team need to
                  complete for the week and day. Take full control of the task
                  management by uploading tasks when received.{' '}
                </p>
